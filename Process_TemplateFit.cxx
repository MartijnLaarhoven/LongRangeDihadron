...
struct ConfigUnit {
    ...
    ConfigUnit(Bool_t _isNch, Bool_t _isPtDiff, InputUnit _template, std::vector<InputUnit> _dataList, std::string _outputFileName) :
        isNch(_isNch), isPtDiff(_isPtDiff), templ(_template), dataList(_dataList), outputFileName(_outputFileName) {}
};
...
void Process_TemplateFit() {
    ...
    // "LHC25af_pass2_554625"));
    // ft0a-ft0c
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_594019", kFT0AFT0C, 80, 100), 
    // {InputUnit("LHC25af_pass2_594019", kFT0AFT0C, 0, 20)}, 
    // "LHC25af_pass2_594019"));
    
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_623297", kFT0AFT0C, 80, 100), 
    // {InputUnit("LHC25af_pass2_623297", kFT0AFT0C, 0, 20)}, 
    // "LHC25af_pass2_623297"));
    
    // tpc-ft0a/c
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_622739", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25af_pass2_622739", kTPCFT0A, 0, 20)}, 
    // "LHC25af_pass2_622739"));
    
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_622739", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25af_pass2_622739", kTPCFT0C, 0, 20)}, 
    // "LHC25af_pass2_622739"));
    
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_623540", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25af_pass2_623540", kTPCFT0A, 0, 20)}, 
    // "LHC25af_pass2_623540"));
    
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_623540", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25af_pass2_623540", kTPCFT0C, 0, 20)}, 
    // "LHC25af_pass2_623540"));

    // O-O
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_623296", kFT0AFT0C, 80, 100), 
    // {InputUnit("LHC25ae_pass2_623296", kFT0AFT0C, 0, 20)}, 
    // "LHC25ae_pass2_623296"));

    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_623296", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25ae_pass2_623296", kTPCFT0A, 0, 20)}, 
    // "LHC25ae_pass2_623296"));

    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_623296", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25ae_pass2_623296", kTPCFT0C, 0, 20)}, 
    // "LHC25ae_pass2_623296"));

    // PtDiff processing for 3times2PC
    // configList.push_back(ConfigUnit(kCent, kPtDiffOn, InputUnit("LHC25af_pass2_623540", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25af_pass2_623540", kTPCFT0A, 0, 20)}, 
    // "LHC25af_pass2_623540"));
    
    // configList.push_back(ConfigUnit(kCent, kPtDiffOn, InputUnit("LHC25af_pass2_623540", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25af_pass2_623540", kTPCFT0C, 0, 20)}, 
    // "LHC25af_pass2_623540"));

    // configList.push_back(ConfigUnit(kCent, kPtDiffOn, InputUnit("LHC25ae_pass2_623296", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25ae_pass2_623296", kTPCFT0A, 0, 20)}, 
    // "LHC25ae_pass2_623296"));

    // configList.push_back(ConfigUnit(kCent, kPtDiffOn, InputUnit("LHC25ae_pass2_623296", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25ae_pass2_623296", kTPCFT0C, 0, 20)}, 
    // "LHC25ae_pass2_623296"));

    // Nch-based template fit (template: Nch 0-10, signal: Nch 10-50)
    configList.push_back(ConfigUnit(kNch, kPtDiffOff, InputUnit("LHC25ae_pass2_634100", kFT0AFT0C, 0, 10),
    {InputUnit("LHC25ae_pass2_634100", kFT0AFT0C, 10, 50)},
    "LHC25ae_pass2_634100"));
    configList.push_back(ConfigUnit(kNch, kPtDiffOff, InputUnit("LHC25ae_pass2_634100", kTPCFT0A, 0, 10),
    {InputUnit("LHC25ae_pass2_634100", kTPCFT0A, 10, 50)},
    "LHC25ae_pass2_634100"));
    configList.push_back(ConfigUnit(kNch, kPtDiffOff, InputUnit("LHC25ae_pass2_634100", kTPCFT0C, 0, 10),
    {InputUnit("LHC25ae_pass2_634100", kTPCFT0C, 10, 50)},
    "LHC25ae_pass2_634100"));
    // PtDiff
    configList.push_back(ConfigUnit(kNch, kPtDiffOn, InputUnit("LHC25ae_pass2_634100", kTPCFT0A, 0, 10),
    {InputUnit("LHC25ae_pass2_634100", kTPCFT0A, 10, 50)},
    "LHC25ae_pass2_634100"));
    configList.push_back(ConfigUnit(kNch, kPtDiffOn, InputUnit("LHC25ae_pass2_634100", kTPCFT0C, 0, 10),
    {InputUnit("LHC25ae_pass2_634100", kTPCFT0C, 10, 50)},
    "LHC25ae_pass2_634100"));

    //innerring
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_594018", kFT0AFT0C, 80, 100), 
    // {InputUnit("LHC25af_pass2_594018", kFT0AFT0C, 0, 20)}, 
    // "LHC25af_pass2_594018"));
    //outterring
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_594020", kFT0AFT0C, 80, 100), 
    // {InputUnit("LHC25af_pass2_594020", kFT0AFT0C, 0, 20)}, 
    // "LHC25af_pass2_594020"));
    // tpc-ft0c
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_586466", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25af_pass2_586466", kTPCFT0C, 0, 20)}, 
    ...
    // {InputUnit("LHC25af_pass2_586594", kTPCFT0C, 0, 20)}, 
    // "LHC25af_pass2_586594"));
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_586594", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25af_pass2_586594", kTPCFT0A, 0, 20)}, 
    // "LHC25af_pass2_586594"));



    // tpc-tpc
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_554627", kTPCTPC, 80, 100), 
    // {InputUnit("LHC25af_pass2_554626", kTPCTPC, 0, 20)}, 
    // "LHC25af_pass2_554627"));
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25af_pass2_554627", kTPCTPC, 80, 100), 
    // {InputUnit("LHC25af_pass2_554626", kTPCTPC, 0, 20)}, 
    // "LHC25af_pass2_554627"));
    // O-O
    ...
    // "LHC25ae_pass2_561907"));    
    // // tpc-ft0c
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_575598", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25ae_pass2_587867", kTPCFT0C, 0, 20)}, 
    // "LHC25ae_pass2_575598"));
    //outterring
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_583826", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25ae_pass2_583828", kTPCFT0C, 0, 20)}, 
    // "LHC25ae_pass2_583826"));
    //innerring
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_584612", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25ae_pass2_583824", kTPCFT0C, 0, 20)}, 
    // "LHC25ae_pass2_584612"));
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_575598", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25ae_pass2_573730", kTPCFT0C, 0, 20)}, 
    // "LHC25ae_pass2_575598"));
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_575598", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25ae_pass2_572180", kTPCFT0C, 0, 20)}, 
    // "LHC25ae_pass2_575598"));    
    // // tpc-ft0a
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_575598", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25ae_pass2_587867", kTPCFT0A, 0, 20)}, 
    // "LHC25ae_pass2_575598"));
    //outterring
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_583826", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25ae_pass2_583828", kTPCFT0A, 0, 20)}, 
    // "LHC25ae_pass2_583826"));
    //innerring
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_584612", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25ae_pass2_583824", kTPCFT0A, 0, 20)}, 
    // "LHC25ae_pass2_584612"));

    //MC
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_586778", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25ae_pass2_586778", kTPCFT0C, 0, 20)}, 
    // "LHC25ae_pass2_586778"));
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_586778", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25ae_pass2_586778", kTPCFT0A, 0, 20)}, 
    // "LHC25ae_pass2_586778"));

    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_588055", kTPCFT0C, 80, 100), 
    // {InputUnit("LHC25ae_pass2_588055", kTPCFT0C, 0, 20)}, 
    // "LHC25ae_pass2_588055"));
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_588055", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25ae_pass2_588055", kTPCFT0A, 0, 20)}, 
    // "LHC25ae_pass2_588055"));    
    


    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_575598", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25ae_pass2_573730", kTPCFT0A, 0, 20)}, 
    // "LHC25ae_pass2_575598"));
    // configList.push_back(ConfigUnit(kCent, kPtDiffOff, InputUnit("LHC25ae_pass2_575598", kTPCFT0A, 80, 100), 
    // {InputUnit("LHC25ae_pass2_572180", kTPCFT0A, 0, 20)}, 
    // "LHC25ae_pass2_575598"));
